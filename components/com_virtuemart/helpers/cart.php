 ...
 * @version $Id: cart.php 10900 2023-07-15 17:40:07Z Milbo $
 */
...
//					unset($data->cartfields['tos']);
	...
	public function updateProductCart() {
		...
		$this->setCartIntoSession($updated);
		return $updated;
	}
...
//			quorvia consider whether the store wants to populate empty ST address with the BT address
	...
	static public function emptyCartValues( &$cart, $session = true){
		...
		$cart->OrderIdOrderDone = $cart->virtuemart_order_id;
		$cart->virtuemart_order_id = false;       //We delete this one later in order done, it should not hurt,...
