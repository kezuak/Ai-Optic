            ...
            setTimeout(function(){
                ...
                XHR.onreadystatechange = function(e){
                    if (XHR.readyState == 4) {
                        ...
                        if ('resave' in itemDelete) {
                            currentContext.find('img').each(function(){
                                this.src = this.src+'1';
                            });
                            currentContext[0] == currentItem[0] ? currentItem.trigger('click') : '';
                        } else {
                            window.frames['upload-target'].galleryApp.reloadFolder();
                        }
                        setTimeout(function(){
...
app.photoEditor = function(){
    ...
    setTimeout(function(){
        ...
        photoEditor(JUri+itemDelete.url+'?time='+(+new Date()));
    }, 600);
}
