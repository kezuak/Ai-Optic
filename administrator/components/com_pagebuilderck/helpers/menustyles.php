...
class MenuStyles extends stdClass {
		...
		<div class="ckoption">
			<div class="menupaneblock">
				...
				<div class="clearfix">
					...
					<a class="ckbuttonstyle" href="javascript:void(0)" onclick="CKBox.open({handler: 'iframe', url: 'index.php?option=com_pagebuilderck&view=browse&type=video&func=ckSelectFile&tmpl=component&fieldid=<?php echo $prefix; ?>videourlmp4'})"><?php echo JText::_('CK_SELECT') ?></a>
				</div>
				<div class="clearfix">
					...
					<a class="ckbuttonstyle" href="javascript:void(0)" onclick="CKBox.open({handler: 'iframe', url: 'index.php?option=com_pagebuilderck&view=browse&type=video&func=ckSelectFile&tmpl=component&fieldid=<?php echo $prefix; ?>videourlwebm'})"><?php echo JText::_('CK_SELECT') ?></a>
				</div>
				<div class="clearfix">
					...
					<a class="ckbuttonstyle" href="javascript:void(0)" onclick="CKBox.open({handler: 'iframe', url: 'index.php?option=com_pagebuilderck&view=browse&type=video&func=ckSelectFile&tmpl=component&fieldid=<?php echo $prefix; ?>videourlogv'})"><?php echo JText::_('CK_SELECT') ?></a>
				</div>
			</div>
			<div class="clr"></div>
		</div>
	...
	public function createIcon($prefix, $fromicon, $space = true, $align = true, $font = false, $useaccordion = false, $removebutton = false, $fontalign = true, $selection = true, $iconhover = false, $iconsize = true) {
		?>
		<input type="hidden" class="inputbox" name="<?php echo $prefix; ?>icontype" id="<?php echo $prefix; ?>icontype" />
		<?php if ($useaccordion) { ?>
		...
		<fieldset id="fontawesomefieldset">
			...
			?>
				<?php if ($font) { ?>
				<div id="fontawesomefieldsetoptions" style="margin-left:10px;">
				...
				<fieldset id="iconsvgfieldset">
					...
					<div class="menupanetitle"><?php echo JText::_('CK_SIZE'); ?></div>
					<div>
						<input type="range" class="inputbox cknoupdate ckrangeinputupdate" id="<?php echo $prefix; ?>iconsvgsize" name="<?php echo $prefix; ?>iconsvgsize" min="8" max="200" value="24" step="4" onchange="ckSetSvgIconSize()">
						<label for="<?php echo $prefix; ?>iconsvgsize"></label> px
					</div>
					<div class="menupanetitle"><?php echo JText::_('CK_STROKE'); ?></div>
					<div>
						<input type="range" class="inputbox cknoupdate ckrangeinputupdate" id="<?php echo $prefix; ?>iconsvgstrokewidth" name="<?php echo $prefix; ?>iconsvgstrokewidth" min="0" max="3" value="2" step="0.2" onchange="ckSetSvgIconStroke()">
						<label for="<?php echo $prefix; ?>iconsvgstroke"></label> px
					</div>
					<div class="menupanetitle"><?php echo JText::_('CK_COLOR'); ?></div>
					<div>
						<input class="inputbox colorPicker cktip" title="<?php echo JText::_('CK_NORMAL_STATE'); ?>" type="text" value="" name="<?php echo $prefix; ?>iconsvgstroke" id="<?php echo $prefix; ?>iconsvgstroke" onblur="ckSetSvgIconStrokeColor()" style="width:52px;"/>
						<?php if ($iconhover) { ?><input class="inputbox colorPicker cktip" title="<?php echo JText::_('CK_HOVER_STATE'); ?>" type="text" value="" name="<?php echo $prefix; ?>hovericonsvgstroke" id="<?php echo $prefix; ?>hovericonsvgstroke" onblur="ckSetSvgIconStrokeColor()" style="width:52px;"/><?php } ?>
						<div style="float:left;margin:5px 5px 0 2px;"><img src="<?php echo $this->imagespath; ?>color.png" width="15" height="15"/></div>
						<?php echo JText::_('CK_STROKE'); ?>
					</div>
					<div>
						<input class="inputbox colorPicker cktip" title="<?php echo JText::_('CK_NORMAL_STATE'); ?>" type="text" value="" name="<?php echo $prefix; ?>iconsvgfill" id="<?php echo $prefix; ?>iconsvgfill" onblur="ckSetSvgIconFillColor()" style="width:52px;"/>
						<?php if ($iconhover) { ?><input class="inputbox colorPicker cktip" title="<?php echo JText::_('CK_HOVER_STATE'); ?>" type="text" value="" name="<?php echo $prefix; ?>hovericonsvgfill" id="<?php echo $prefix; ?>hovericonsvgfill" onblur="ckSetSvgIconFillColor()" style="width:52px;"/><?php } ?>
						<div style="float:left;margin:5px 5px 0 2px;"><img src="<?php echo $this->imagespath; ?>color.png" width="15" height="15"/></div>
						<?php echo JText::_('CK_FILL'); ?>
					</div>
					<?php /*
					<div class="menupanetitle"><?php echo JText::_('CK_ICON_POSITION'); ?></div>
	...
	public function createIconSvgLight($prefix) {
		?>
		<input type="hidden" class="inputbox" name="<?php echo $prefix; ?>icontype" id="<?php echo $prefix; ?>icontype" />
		<fieldset>
			<legend><?php echo JText::_('CK_SVG_ICON'); ?></legend>
			<div style="">
				<div class="menupanetitle"><?php echo JText::_('CK_FILL'); ?></div>
				<div>
					<input class="inputbox colorPicker" type="text" value="" name="<?php echo $prefix; ?>iconsvgfill" id="<?php echo $prefix; ?>iconsvgfill" style="width:65px;"/>
					<div style="float:left;margin:5px 5px 0 2px;"><img src="<?php echo $this->imagespath; ?>color.png" width="15" height="15"/></div>
				</div>
			...
			<div style="">
				<div class="menupanetitle"><?php echo JText::_('CK_STROKE'); ?></div>
				<div>
					<input class="inputbox colorPicker" type="text" value="" name="<?php echo $prefix; ?>iconsvgstroke" id="<?php echo $prefix; ?>iconsvgstroke" style="width:65px;"/>
					<div style="float:left;margin:5px 5px 0 2px;"><img src="<?php echo $this->imagespath; ?>color.png" width="15" height="15"/></div>
				</div>
	...
	public function createIconLight($prefix) {
		...
		<fieldset>
			...
			<div style="float:left; width: 40%;">
				<div class="menupanetitle"><?php echo JText::_('CK_FONTSIZE'); ?></div>
				<div>
					<input class="inputbox ckresponsivable" type="text" value="" name="<?php echo $prefix; ?>fontsize" id="<?php echo $prefix; ?>fontsize" style="width:60px;" placeholder="13"/>
					<div style="float:left;margin:5px 5px 0 2px;"><img src="<?php echo $this->imagespath; ?>width.png" width="15" height="15"/></div>
			</div>
			</div>
		</fieldset>
		<div style="clear:both;"></div>
		...
		<div class="menustylesblock" >
			...
			<div class="menustylesblockaccordion">
				...
				if ($usegradient) {
					...
					<div class="menupaneblock" style="width: 195px;overflow:hidden;">
	...
	public function createSingleBorders($prefix) {
		?>
		<div class="menupaneblock" style="margin:0 15px 0 0;">
			<div class="menupanetitle"><?php echo JText::_('CK_BORDERS'); ?></div>
			<div style="float:left;">
				<input class="inputbox ckresponsivable colorPicker" type="text" value="" name="<?php echo $prefix; ?>borderscolor" id="<?php echo $prefix; ?>borderscolor" size="6" style="width:55px;" />
			</div>
			<div style="float:left;margin:4px 2px 0 2px;"><img src="<?php echo $this->imagespath; ?>color.png" width="15" height="15"/></div>
			<input class="inputbox ckresponsivable" type="text" style="width:30px;" name="<?php echo $prefix; ?>borderssize" id="<?php echo $prefix; ?>borderssize" ><?php echo JText::_('CK_SIZE'); ?>
			<select class="inputbox" style="width:78px;height:22px;" name="<?php echo $prefix; ?>bordersstyle" id="<?php echo $prefix; ?>bordersstyle" >
				<option value="solid">solid</option>
				<option value="dotted">dotted</option>
				<option value="dashed">dashed</option>
	...
	?>
		<div class="ckoption">
			<span class="ckoption-label">
				...
				<?php echo JText::_('CK_DURATION'); ?></span>
			<span class="ckoption-field">
				<input class="inputbox <?php echo $prefix; ?>" type="text" name="<?php echo $prefix; ?>fxdur" id="<?php echo $prefix; ?>fxdur" value="1" style="width:105px;" /> [s]
			</span>
			<div class="clr"></div>
		</div>
		<div class="ckoption">
			<span class="ckoption-label">
				...
				<?php echo JText::_('CK_DELAY'); ?></span>
			<span class="ckoption-field">
				<input class="inputbox <?php echo $prefix; ?>" type="text" name="<?php echo $prefix; ?>fxdelay" id="<?php echo $prefix; ?>fxdelay" value="0" style="width:105px;" /> [s]
			</span>
			<div class="clr"></div>
		</div>
		<?php /*
		...
		<div class="ckoption">
			...
			<span class="ckoption-field">
				<input placeholder="0 to 1" class="inputbox ckrangeinputupdate <?php echo $prefix; ?>" type="range" min="0" max="1" step="0.1" name="<?php echo $prefix; ?>fxopacity" id="<?php echo $prefix; ?>fxopacity" value="1" style="width:105px;" />
		...
		<div class="ckoption">
			...
			<span class="ckoption-field">
				<input placeholder="0 to 1" class="inputbox ckrangeinputupdate <?php echo $prefix; ?>" type="range" min="0" max="1" step="0.1" name="<?php echo $prefix; ?>hoverfxopacity" id="<?php echo $prefix; ?>hoverfxopacity" value="1" style="width:105px;" />
				<input type="text" onchange="ckUpdateRangeInputs(this)" />
			</span>
		</div>
		...
		<div class="ckoption">
			...
			<span class="ckoption-field">
				<select class="inputbox <?php echo $prefix; ?> hasTip" title="<?php echo JText::_('CK_DIRECTION'); ?>" type="list" name="<?php echo $prefix; ?>fxmovedir" id="<?php echo $prefix; ?>fxmovedir" value="" style="width: 114px;" >
					<option value="ltrck"><?php echo JText::_('CK_LEFT_TO_RIGHT'); ?></option>
					<option value="rtlck"><?php echo JText::_('CK_RIGHT_TO_LEFT'); ?></option>
					<option value="ttbck"><?php echo JText::_('CK_TOP_TO_BOTTOM'); ?></option>
					<option value="bttck"><?php echo JText::_('CK_BOTTOM_TO_TOP'); ?></option>
		...
		<div class="ckoption">
			...
			<span class="ckoption-field">
				<input placeholder="" class="inputbox <?php echo $prefix; ?> hasTip" title="<?php echo JText::_('CK_DISTANCE'); ?>" type="text" name="<?php echo $prefix; ?>fxmovedist" id="<?php echo $prefix; ?>fxmovedist" value="" /> [px]
			</span>
		</div>
		<div class="ckoption">
			<span class="ckoption-label">
			...
			<span class="ckoption-field">
				<input placeholder="" class="inputbox <?php echo $prefix; ?>hover hasTip" title="<?php echo JText::_('CK_DISTANCE'); ?>" type="text" name="<?php echo $prefix; ?>hoverfxmovedist" id="<?php echo $prefix; ?>hoverfxmovedist" value="" /> [px]
			</span>
		</div>
		...
		<div class="ckoption">
			...
			<span class="ckoption-field">
				<input class="inputbox ckrangeinputupdate <?php echo $prefix; ?>" type="range" min="-180" max="180" step="1" name="<?php echo $prefix; ?>fxrotrad" id="<?php echo $prefix; ?>fxrotrad" value="0" style="width:105px;" /> °
				<input type="text" onchange="ckUpdateRangeInputs(this)" />
			</span>
		</div>
		<div class="ckoption">
			...
			<span class="ckoption-field">
				<input placeholder="0" class="inputbox ckrangeinputupdate <?php echo $prefix; ?>hover" type="range" min="-180" max="180" step="1" name="<?php echo $prefix; ?>hoverfxrotrad" id="<?php echo $prefix; ?>hoverfxrotrad" value="0" style="width:105px;"  /> °
				<input type="text" onchange="ckUpdateRangeInputs(this)" />
			</span>
		</div>
		...
		<div class="ckoption">
			...
			<span class="ckoption-field">
				<input placeholder="1" class="inputbox ckrangeinputupdate <?php echo $prefix; ?>" type="range" min="0" max="2" step="0.1" name="<?php echo $prefix; ?>fxscale" id="<?php echo $prefix; ?>fxscale" value="" style="width:105px;"/>
				<input type="text" onchange="ckUpdateRangeInputs(this)" />
			</span>
		</div>
		<div class="ckoption">
			...
			<span class="ckoption-field">
				<input placeholder="1" class="inputbox ckrangeinputupdate <?php echo $prefix; ?>hover" type="range" min="0" max="2" step="0.1" name="<?php echo $prefix; ?>hoverfxscale" id="<?php echo $prefix; ?>hoverfxscale" value="" style="width:105px;"/>
				<input type="text" onchange="ckUpdateRangeInputs(this)" />
			</span>
		</div>
		...
		<div class="ckoption">
			...
			<span class="ckoption-field">
				<input placeholder="1" class="inputbox ckrangeinputupdate <?php echo $prefix; ?>" type="range" min="0" max="1" step="0.1" name="<?php echo $prefix; ?>fxblur" id="<?php echo $prefix; ?>fxblur" value="0" style="width:105px;"/>
				<input type="text" onchange="ckUpdateRangeInputs(this)" />
			</span>
		</div>
		<div class="ckoption">
			...
			<span class="ckoption-field">
				<input placeholder="1" class="inputbox ckrangeinputupdate <?php echo $prefix; ?>hover" type="range" min="0" max="1" step="0.1" name="<?php echo $prefix; ?>hoverfxblur" id="<?php echo $prefix; ?>hoverfxblur" value="0" style="width:105px;"/>
				<input type="text" onchange="ckUpdateRangeInputs(this)" />
			</span>
		</div>
		...
		<div class="ckoption">
			...
			<span class="ckoption-field">
				<input placeholder="1" class="inputbox ckrangeinputupdate <?php echo $prefix; ?>" type="range" min="0" max="2" step="0.1" name="<?php echo $prefix; ?>fxbrightness" id="<?php echo $prefix; ?>fxbrightness" value="1" style="width:105px;"/>
				<input type="text" onchange="ckUpdateRangeInputs(this)" />
			</span>
		</div>
		<div class="ckoption">
			...
			<span class="ckoption-field">
				<input placeholder="1" class="inputbox ckrangeinputupdate <?php echo $prefix; ?>hover" type="range" min="0" max="2" step="0.1" name="<?php echo $prefix; ?>hoverfxbrightness" id="<?php echo $prefix; ?>hoverfxbrightness" value="1" style="width:105px;"/>
				<input type="text" onchange="ckUpdateRangeInputs(this)" />
			</span>
		</div>
		...
		<div class="ckoption">
			...
			<span class="ckoption-field">
				<input placeholder="1" class="inputbox ckrangeinputupdate <?php echo $prefix; ?>" type="range" min="0" max="1" step="0.1" name="<?php echo $prefix; ?>fxgrayscale" id="<?php echo $prefix; ?>fxgrayscale" value="0" style="width:105px;"/>
				<input type="text" onchange="ckUpdateRangeInputs(this)" />
			</span>
		</div>
		<div class="ckoption">
			...
			<span class="ckoption-field">
				<input placeholder="1" class="inputbox ckrangeinputupdate <?php echo $prefix; ?>hover" type="range" min="0" max="1" step="0.1" name="<?php echo $prefix; ?>hoverfxgrayscale" id="<?php echo $prefix; ?>hoverfxgrayscale" value="0" style="width:105px;"/>
				<input type="text" onchange="ckUpdateRangeInputs(this)" />
			</span>
		</div>
	<?php
